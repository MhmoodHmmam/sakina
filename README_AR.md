...
## أعمال ذات صلة — وما الفرق

تقف «سكينة» على أرضٍ سبق أن رسم غيرُنا معالمها، وتسميتها أنصف لهم وأوضح للمُحكِّم.

- **الشبكة كمستشعر للحشود.** بحث Orange على بيانات إشارات الشبكة يكشف أحداثاً حضرية من فئة التدافع بدقة الدقيقة ([Lemaire et al., PLOS ONE 2024](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0309093)) لكنه صراحةً *غير مُصمَّم ليعمل ذاتياً*؛ و[واجهة CAMARA لكثافة السكان](https://developer.orange.com/blog/camara-population-density-data-api-and-flux-vision/) راقبت ١٠٠ مدخل في أولمبياد باريس ٢٠٢٤. *«سكينة» تُغلق الحلقة — استشعار، حكم، فعل — دون أي تدخل من المشغّل.*
- **وكيل يرفع جودة الخدمة عند الازدحام.** [عرض Nokia مع Summit Tech في MWC26](https://www.summit-tech.ca/en/mwc26-nokia) يجعل وكلاء ذكاء اصطناعي يراقبون الازدحام عبر MCP ويطلبون QoD لبثّ 8K. *«سكينة» تعامل كل قراءة ازدحام كدليلٍ بوزنٍ معلوم، وتستدل هل انخفاض الازدحام تفرّقٌ حقيقي أم عمى في القياس، وتقرّر بنفسها متى يستحق هذا الشك خمس استدعاءات إضافية.*
- **فحص شبكي يحكم فعل الوكيل.** [مساعد مصرفي من Orange](https://developer.orange.com/blog/from-blind-bots-to-network-aware-agents-securing-mobile-banking-with-mcp-and-orange-sim-swap-api/) يرفض الدفع اللاتلامسي إذا بُدِّلت الشريحة خلال ٤٨ ساعة (يوليو ٢٠٢٦). *«سكينة» تطبّق النمط نفسه على الطيف: تبديل الشريحة والتجوال والتحقق من الموقع تحكم رفع QoD، وتفشل مغلقةً.*
- **إدارة حشود الحج.** تهيمن كثافة الحشود من الكاميرات — مثل براءة KFUPM [US 12,417,639](https://patents.google.com/patent/US12417639) (كثافة من CCTV ورسائل SMS للحجاج). *«سكينة» لا تحتاج مستشعرات جديدة؛ كل حاجّ يحمل واحداً.*
- **QoD للمستجيبين الأوائل** حالة استخدام راسخة في CAMARA. *لا ندّعي جِدّتها؛ الجديد هو من يحصل عليها ولماذا.*

ما يكسبه مركز التحكم: إنذار أبكر دون عتاد جديد؛ لا طمأنينة زائفة من قراءة «منخفض» تبدو واثقة؛ ونطاق ترددي ذو أولوية لا يناله منتحل.
